...
This is the **full** write-memory protocol. The shorter index version lives at [`01-write-memory.md`](./01-write-memory.md) — both must stay in sync.
...
*Sync with `01-write-memory.md` and any future `ai-onboarding-prompt.md`.*
