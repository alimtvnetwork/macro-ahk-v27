...
```powershell
# Windows · PowerShell
irm https://github.com/alimtvnetwork/macro-ahk-v26/releases/download/v2.158.0/install.ps1 | iex
```

```bash
# macOS · Linux · Bash
curl -fsSL https://github.com/alimtvnetwork/macro-ahk-v26/releases/download/v2.158.0/install.sh | bash
```
...
```powershell
& { $Version = "v2.150.0"; irm https://raw.githubusercontent.com/alimtvnetwork/macro-ahk-v26/main/scripts/install.ps1 | iex }
```

```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/macro-ahk-v26/main/scripts/install.sh | bash -s -- --version v2.150.0
```
